...
# CLIPを使ったコーパス生成
def generate_clip_corpus(corpus_file_path, data_dir, output_dir):
    # CLIPモデルとプロセッサのロード
    ...
    output_path = os.path.join(output_dir, 'corpus_vectors_clip_ViT-L-14_val14.pt')
...
if __name__ == "__main__":
    ...
    generate_clip_corpus(corpus_file_path, data_dir, output_dir)
